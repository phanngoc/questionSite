class HomeController < ApplicationController
  ...
  def index
    ...
    if params.has_key? :word_search
      ...
      @questions = @q.result.includes([:topics, :user, :actions]).paginate(page: params[:page], per_page: Settings.home.per_page)
      ...
      if user_signed_in?
        ...
        @questions = Question.includes([:topics, :user, :actions]).paginate(page: params[:page], per_page: Settings.home.per_page)
      end
    end  
  end
end
